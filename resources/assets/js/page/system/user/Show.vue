<template>
    <div class="form-elements">
        <div class="row">
            <div class="col-md-12">
                <vuestic-widget headerText="用户详情">
                    <form>
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-info"
                                                @click="$router.push({name:'system.user.edit',params:{id:$route.params.id}})">
                                            编辑
                                        </button>
                                    </div>
                                </fieldset>
...
<script>
    import {showSystemUser} from './../../../api/api';
    ...
    export default {
        ...
        methods: {
            fetchUser() {
                showSystemUser(this.form).then((response) => {
