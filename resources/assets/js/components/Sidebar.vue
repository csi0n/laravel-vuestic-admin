        ...
        <vuestic-scrollbar>
            <ul class="sidebar-menu">
                <li v-for="(item, index) in menuItems">
                    ...
                    <a href="#" @click.prevent="toggleMenuItem(item)" class="sidebar-link"
                    ...
                    <expanding>
                        <ul class="sidebar-submenu" v-show="item.expanded">
                            <li v-for="item in item.child">
                                <router-link :to="{name:item.url}" class="sidebar-link sidebar-submenu-link">
                                    {{item.name}}
                                </router-link>
                            </li>
                        </ul>
